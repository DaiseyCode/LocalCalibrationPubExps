...
__all__ = ["HistogramCalibrator", "PlattCalibrator", "PlattHistogramCalibrator"]
...
class PlattCalibrator(BaseEstimator):
    ...
    fit_intercept : bool, default True
        Whether to fit the intercept of the logistic regression.
        Disable to make it more like temperature scaling.
    ...
    def __init__(self, log_odds: bool = True, fit_intercept: bool = True):
...
class PlattHistogramCalibrator(PlattCalibrator):
    ...
    def fit(self, y_prob: np.ndarray, y_true: np.ndarray):
        ...
        binned_y_true, binned_y_prob = create_binned_data(
            y_true,
            y_prob_platt,
            self.n_bins,
        )
